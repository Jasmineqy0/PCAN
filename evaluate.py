...
parser.add_argument('--model_file', default='base.ckpt', help='Log dir [default: log]')
parser.add_argument('--dataset', default='business', help='Log dir [default: log]')
parser.add_argument('--logdir', default='models', help='Log dir [default: log]')
